...
let build = gulp.series(clean, gulp.parallel(css, html, img, js));  //series - последовательно /   сначала начинает работать clean, а потом параллельно запускается остальное
